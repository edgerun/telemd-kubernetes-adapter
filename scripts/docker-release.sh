...
docker build -t ${basetag}-arm32v7 -f build/package/telemd-kubernetes-adapter/Dockerfile.arm32v7 .
docker build -t ${basetag}-aarch64 -f build/package/telemd-kubernetes-adapter/Dockerfile.aarch64 .
